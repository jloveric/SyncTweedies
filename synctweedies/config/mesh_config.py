...
def load_mesh_config():
    ...
    parser.add_argument("--app", type=str, default="mesh")
    ...
    parser.add_argument('--save_top_dir', type=str, default=None, help="If not provided, use the parent directory of config file for output")
    ...
    parser.add_argument("--case_num", type=str, default="1", required=True)
